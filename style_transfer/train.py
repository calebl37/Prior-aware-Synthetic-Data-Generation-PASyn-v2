...
if __name__ == "__main__":
    ...
    parser.add_argument('--alpha', type=float, default=0.5, help='Style interpolation weight (0-1)')
    parser.add_argument('--l_content_weight', type=float, default = 5.0, help='Weight for content loss')
    parser.add_argument('--l_style_weight', type=float, default=10.0, help='Weight for style loss')
